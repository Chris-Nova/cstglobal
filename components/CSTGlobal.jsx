  ...
  const fetchSources = useCallback(async () => {
    ...
    try {
      ...
      setSources([
        ...
        { key:"nashville_permits",  label:"Louisville Permits",   region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"new_orleans_permits",label:"New Orleans Permits", region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"las_vegas_permits",  label:"Cincinnati Permits",  region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"raleigh_permits",    label:"Chattanooga Permits",     region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"nashville_permits",label:"Louisville Permits",  region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"nola_permits",     label:"New Orleans Permits",region:"Americas",    type:"City Permit",            count:0, last_run:null },
        { key:"lv_permits",       label:"Las Vegas Permits",  region:"Americas",     type:"City Permit",            count:0, last_run:null },
        { key:"raleigh_permits",  label:"Chattanooga Permits",    region:"Americas",     type:"City Permit",            count:0, last_run:null },
